                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :dots="false" :nav="false">
                                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == gambar_utama ? 'active' : '' ">
                                        <img src="img/shoes/af1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] == gambar_utama ? 'active' : '' ">
                                        <img src="img/shoes/af2.png" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == gambar_utama ? 'active' : '' ">
                                        <img src="img/shoes/af3.png" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[3])" :class="thumbs[3] == gambar_utama ? 'active' : '' ">
                                        <img src="img/shoes/af4.png" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[4])" :class="thumbs[4] == gambar_utama ? 'active' : '' ">
                                        <img src="img/shoes/af5.png" alt="" />
                                    </div>
                                </carousel>
                            </div>
                        </div>
...
export default {
    ...
    data() {
        return {
            gambar_utama: "img/shoes/af1.jpg",
            thumbs: [
                "img/shoes/af1.jpg",
                "img/shoes/af2.png",
                "img/shoes/af3.png",
